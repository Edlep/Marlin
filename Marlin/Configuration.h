...
#define ENABLE_AUTO_BED_LEVELING // Delete the comment to enable (remove // at the start of the line)
  ...
  #define DELTA_PROBABLE_RADIUS (DELTA_PRINTABLE_RADIUS - 2) //* 3./4.)
...
#define MANUAL_Z_HOME_POS 288.3  // For delta: Distance between nozzle and print surface after homing.
...
#define EXTRUDER_OFFSET_X {-13.0, 13.00} // (in mm) for each extruder, offset of the hotend on the X axis
#define EXTRUDER_OFFSET_Y {-2.0, 2.00}  // (in mm) for each extruder, offset of the hotend on the Y axis
